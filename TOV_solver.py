...
# Energiatiheys
NS_EoS_ic_core_rho = np.flip(np.append(NS_EoS__ic_rho,
                                       NS_EoS__core_rho) * 7.4261e-25, -1)
# print("energiatiheys")
...
NS_EoS_ic_core_P = np.flip(np.append(NS_EoS__ic_P,
                                     NS_EoS__core_P) * 8.2627e-46, -1)
# print("Paine")
